...
const automationContract = `Local JavaScript owns all new schedules and event rules. Deterministic callbacks need NO LLM calls. For scheduled fresh research/summaries use assistant.run inside the local callback; do not hide the schedule in legacy scheduleActions or duplicate it there.
