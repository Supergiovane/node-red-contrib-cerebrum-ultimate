...
// Modified for Cerebrum: node type, read-only data facade, shared core settings/library, and a version guard for linkcall.
// Upstream: Node-RED 5.0.7. See nodes/vendor/node-red-function/README.md.
module.exports = function(RED) {
    ...
    var createCerebrumFunctionContext = require("./utils/cerebrumFunctionContext").createCerebrumFunctionContext;
    ...
    function FunctionNode(n) {
        ...
        node.linkcall = async function (target, msg, options) {
            ...
            if (!RED.nodes.linkcallTargets) {
                throw new Error("node.linkcall requires Node-RED 5 or later");
            }
        ...
        var sandbox = {
            cerebrum: createCerebrumFunctionContext(id => RED.nodes.getNode(id), n.cerebrumNode),
            console:console,
            util:util,
            Buffer:Buffer,
            URL: URL,
    ...
    // Use the native Function settings and library, already registered by Node-RED.
    RED.nodes.registerType("cerebrum-function",FunctionNode, {
