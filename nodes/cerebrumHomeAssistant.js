...
module.exports = function (RED) {
  function cerebrumHomeAssistant (config) {
    ...
    node.on('input', function (msg, send, done) {
      try {
        ...
        const event = normalizeCerebrumHomeAutomationEvent(msg, {
          adapterId: HOME_ASSISTANT_ADAPTER_ID,
          providerId: node.id
        })
        if (event) {
  ...
  RED.nodes.registerType('cerebrumHomeAssistant', cerebrumHomeAssistant)
}
